    ...
    return (
        <div className="hero min-h-screen bg-base-100">
            <div className="hero-content flex-col lg:flex-row-reverse gap-x-64">
                ...
                <div>
                    <h1 className="text-4xl font-bold">Welcome To <span className='font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-red-500 font-mono'>HAMMER</span> Store</h1>
