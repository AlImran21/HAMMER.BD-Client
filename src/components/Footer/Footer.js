...
const Footer = () => {
    return (
        <footer class="footer p-10 bg-base-200 text-base-content lg:flex lg:justify-evenly">
            <div>
            ...
            <div>
                ...
                <div class="grid grid-flow-col gap-4">
                    ...
                    <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-behance" viewBox="0 0 16 16">
