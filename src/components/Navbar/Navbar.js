...
const Navbar = () => {
    ...
    const menuItems = <>
        ...
        <li>{user ? <button onClick={logout} className="btn btn-ghost capitalize text-[17px] font-normal">Sign Out</button> : <Link to='/login'>Login</Link>}</li>
    </>
        ...
        <div className="navbar bg-white lg:px-24 z-50">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex="0" className="menu menu-compact dropdown-content mt-2 shadow bg-base-100 rounded-box w-52 font-serif">
                        {menuItems}
                    </ul>
                </div>
            ...
            <div className="navbar-center hidden lg:flex">
                <ul className="menu menu-horizontal p-0 text-[17px] font-medium font-serif ">
                    {menuItems}
                </ul>
            </div>
